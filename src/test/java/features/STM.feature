...
#TC_01 Prenegotiated, User, Groups, Settings, Integration  tab should not be visible to STM
  Scenario Outline:  Prenegotiated, User, Groups, Settings, Integration  tab should not be visible to STM
 ...
 #TC_05, TC_06 STM cannot cancel and delete a project from STM project list
  Scenario Outline: TC_05, TC_06 STM cannot cancel and delete a project from STM project list
    Given Login with Credentials "<UserType>"
    ...
    Examples:
      ...
      | STM      | Patentability   | Biotechnology   | TC_5_6_STM   |

  #TC_07, TC_08_Validate that when STM update or delete a prenegotiated project name, project created using that renegotiated value should not be updated.
  Scenario Outline: TC_07, TC_08_Validate that when STA update or delete a prenegotiated project name, project created by STAM using that prenegotiated value should not be updated.
    ...
    Examples:
      ...
      | STM      | IPC Dev - Goodman & Co. | Jesse Pinkman | TC_07_PRENEGOTIATED_E2E_ | TC_07_PRENEGOTIATED_E2E_Flow_Desc |              |                |                         | 123  | 100   | 90     | CNY - Yuan Renminbi |                |                 | Standard delivery | Biotechnology   | TC_7_STM     | Updated_TC_07_PRENEGOTIATED_E2E_ |
...
#TC_09_Validate import references functionality in a project
  Scenario Outline: TC_09_Validate import references functionality in a project
    ...
    Examples:
      ...
      | Patentability   | Biotechnology   | TC_09_STM    | STM      | Feature1:123,Feature2:787,Feature3:7898 | US3525361 US3525362 ABC | A cannot be found. | US3525361 US3525362 |
  ...
  Scenario Outline: TC_10_Validate add reference manually functionality in a project
    ...
    Examples:
      ...
      | Patentability   | Biotechnology   | TC_10_STM    | STM      | Manual Ref Title | Jesse PinkMan | General_Comment | 2020-03-18       | www.google.com | Citations | Source | Manual Abstract | DOI | Keywords | Full_text |
  ...
  Scenario Outline: TC_11_Validate Upload Patent functionality in a project
    ...
    Examples:
      ...
      | Patentability   | Biotechnology   | TC_11_STM    | STM      | Manual Ref Title | Manual Abstract | 1228337            | USSy1233  | Sample Inventor |



#TC_12, STM13, TC_14 _Validate STM can add, edit and delete annotation to a project
  Scenario Outline: TC_12, STM13, TC_14 _Validate STM can add, edit and delete annotation to a project
    Given Login with Credentials "<UserType>"
    And User filled all mandatory fields on page "both" with "<Type_Of_Project>", "<Technical_Field>", "<CaseMatterNo>"
    And Project is "successfully" created with name "<CaseMatterNo>"
    And Open created Project
...
#TC_16_Validate STM can import features
  Scenario Outline: TC_16_Validate STM can import features
    Given Login with Credentials "<UserType>"
    And User filled all mandatory fields on page "both" with "<Type_Of_Project>", "<Technical_Field>", "<CaseMatterNo>"
    And Project is "successfully" created with name "<CaseMatterNo>"
    And Open created Project
    ...
    Examples:
      ...
      | Patentability   | Biotechnology   | TC_16_STM    | STM      | Feature_1,Feature_2,Feature_3 | C:\GIT\ip-search\Features.csv |


    #TC_15, TC_17, TC_18, TC_19 Validate STM can add, update, reorder and delete features
  Scenario Outline: TC_15, TC_17, TC_18, TC_19 Validate STM can add, update, reorder and delete features
    Given Login with Credentials "<UserType>"
    And User filled all mandatory fields on page "both" with "<Type_Of_Project>", "<Technical_Field>", "<CaseMatterNo>"
    And Project is "successfully" created with name "<CaseMatterNo>"
    And Open created Project
    ...
    Examples:
      ...
      | Patentability   | Biotechnology   | Functional_Automation_Feature_Test | STM      | Feature1:123,Feature2:787,Feature3:7898 | UpdatedFeature1:123,UpdateFeature2:787,UpdateFeature3:7898 | Feature2:787,Feature1:123,Feature3:7898 |



#STM_20_21 Validate STM can upload interim and Final report to a projects
  Scenario Outline: STM_20_21 Validate STM can upload interim and Final report to a projects
    Given Login with Credentials "<UserType>"
    And User filled all mandatory fields on page "both" with "<Type_Of_Project>", "<Technical_Field>", "<CaseMatterNo>"
    And Project is "successfully" created with name "<CaseMatterNo>"
    And Open created Project
    ...
    Examples:
      ...
      | Patentability   | Biotechnology   | TC_20_STM_Interim | STM      | new Interim Report | Interim report | Search in progress | Interim |
      | Patentability   | Biotechnology   | TC_20_STM_Final   | STM      | new Interim Report | Final report   | Report available   | Final   |

    #STM_25 and STM 26_Validate re-order and sorting results for STM
  Scenario Outline:STM_25 and STM 26_Validate re-order and sorting results for STM
    Given Login with Credentials "<UserType>"
    And User filled all mandatory fields on page "both" with "<Type_Of_Project>", "<Technical_Field>", "<CaseMatterNo>"
    And Project is "successfully" created with name "<CaseMatterNo>"
    And Open created Project
    ...
    Examples:
      ...
      | Patentability   | Biotechnology   | TC_25_STM    | STM      | Feature1:123,Feature2:787,Feature3:7898 | US3525361 US3525362 ABC | A cannot be found. | US3525362,US3525361  | US3525361,US3525362   |

  #STM_23, STM_24, and STM_27 STM can add keyword, share a reference in a project also add category to a references should not be available for STM in a project
  Scenario Outline: STM_23, STM_24, and STM_27 STM can add keyword, share a reference in a project also add category to a references should not be available for STM in a project
    Given Login with Credentials "<UserType>"
    And User filled all mandatory fields on page "both" with "<Type_Of_Project>", "<Technical_Field>", "<CaseMatterNo>"
    And Project is "successfully" created with name "<CaseMatterNo>"
    And Open created Project
    ...
    Examples:
      ...
      | Patentability   | Biotechnology   | TC_23_24_27_STM | STM      | Feature1:123,Feature2:787,Feature3:7898 | US6000000  |                    | US6000000        | keywordOne | wilmer.yates@nomail.example.com |


#STM_28_STM can add/update Introduction to a project
  Scenario Outline: STM_28_STM can add/update Introduction to a project
    Given Login with Credentials "<UserType>"
    And User filled all mandatory fields on page "both" with "<Type_Of_Project>", "<Technical_Field>", "<CaseMatterNo>"
    And Project is "successfully" created with name "<CaseMatterNo>"
    And Open created Project
    ...
    Examples:
      ...
      | Patentability   | Biotechnology   | TC_28_STM    | STM      | TC_28_STM_ New Introduction | TC_28_STM_ New Introduction_updated sucessfully |


#STM_29_31_32_Validate STM can add, Update and delete Search history line by line
  Scenario Outline: STM_29_31_32_Validate STM can add, update and delete Search history line by line
    Given Login with Credentials "<UserType>"
    And User filled all mandatory fields on page "both" with "<Type_Of_Project>", "<Technical_Field>", "<CaseMatterNo>"
    And Project is "successfully" created with name "<CaseMatterNo>"
    And Open created Project
...
#    Then "<Search_History_Delete_Entry>" is deleted successfully with message "No Search History has been added"
    ...
    Examples:
      ...
      | Patentability   | Biotechnology   | TC_28_STM    | STM      | Robotics and Automation Society | 1   | new Query for Robotics and Automation Society | 100    | Yes      | 10          | Updated new Query for Robotics and Automation Society | 8999           | no               |

#STM_33_Validate STM can re-order Search history
  Scenario Outline: STM_33_Validate STM can re-order Search history
    Given Login with Credentials "<UserType>"
    And User filled all mandatory fields on page "both" with "<Type_Of_Project>", "<Technical_Field>", "<CaseMatterNo>"
    And Project is "successfully" created with name "<CaseMatterNo>"
    And Open created Project
    ...
    Examples:
      ...
      | Patentability   | Biotechnology   | TC_33_STM    | STM      | Robotics and Automation Society | 1   | new Query for Robotics and Automation Society | 100    | Yes      | Engineering Village     | 100  | new Query for Engineering Village | 900     | Yes       |


  #STL_36, 37 and 38 STM can add, update and delete proposal to a project
  Scenario Outline: STL_36, 37 and 38 STM can add, update and delete proposal to a project
    Given Login with Credentials "<UserType>"
    And User filled all mandatory fields on page "both" with "<Type_Of_Project>", "<Technical_Field>", "<CaseMatterNo>"
    And Project is "successfully" created with name "<CaseMatterNo>"
    And Open created Project
    ...
    Examples:
      ...
      | Patentability   | Biotechnology   | TC_36_STM    | STM      | Proposal One  | proposalOne summary | EUR - Euro |
