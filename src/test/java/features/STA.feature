Feature: Validate various scenarios w.r.t. Search team Admin
...
#TC_02, TC_03, TC_04 can add, update and delete a new pre-negotiated project type  from "Prenegotiated"tab
  Scenario Outline: TC_02, TC_03, TC_04 can add, update and delete a new pre-negotiated project type  from "Prenegotiated"tab
    ...
    Examples:
      ...
      | STA      | IPC Dev - Goodman & Co. | Jesse Pinkman | TC_02_PRENEGOTIATED_E2E_ | TC_02_PRENEGOTIATED_E2E_Flow_Desc |              |                |                         | 123  | 100   | 90     | CNY - Yuan Renminbi |                |                 | Standard delivery | Updated_TC_02_PreNeg |


 #TC_05, TC_06 STA can cancel and delete a project from STM project list
  Scenario Outline: TC_05, TC_06 STA can cancel and delete a project from STM project list
    Given Login with Credentials "<UserType>"
    ...
    Examples:
      ...
      | STA      | Patentability   | Biotechnology   | TC_5_6_STA   |

  #TC_07, TC_08_Validate that when STA update or delete a prenegotiated project name, project created using that renegotiated value should not be updated.
  Scenario Outline: TC_07, TC_08_Validate that when STA update or delete a prenegotiated project name, project created using that renegotiated value should not be updated.
    Given Login with Credentials "<UserType>"
    ...
    Examples:
      ...
      | STA      | IPC Dev - Goodman & Co. | Jesse Pinkman | TC_07_PRENEGOTIATED_E2E_ | TC_07_PRENEGOTIATED_E2E_Flow_Desc |              |                |                         | 123  | 100   | 90     | CNY - Yuan Renminbi |                |                 | Standard delivery | Biotechnology   | TC_7_STA     | Updated_TC_07_PRENEGOTIATED_E2E_ |
...
#TC_09_Validate import references functionality in a project
  Scenario Outline: TC_09_Validate import references functionality in a project
    ...
    Examples:
      ...
      | Patentability   | Biotechnology   | TC_09_STA    | STA      | Feature1:123,Feature2:787,Feature3:7898 | US3525361 US3525362 ABC | A cannot be found. | US3525361 US3525362 |
#      | Patentability   | Biotechnology   | TC_09_STA    | STL      | Feature1:123,Feature2:787,Feature3:7898 | US3525361 US3525362 ABC | A cannot be found. | US3525361 US3525362 |
#      | Patentability   | Biotechnology   | TC_09_STA    | STM      | Feature1:123,Feature2:787,Feature3:7898 | US3525361 US3525362 ABC | A cannot be found. | US3525361 US3525362 |
#      | Patentability   | Biotechnology   | TC_09_STA    | IPPU     | Feature1:123,Feature2:787,Feature3:7898 | US3525361 US3525362 ABC | A cannot be found. | US3525361 US3525362 |
  ...
  Scenario Outline: TC_10_Validate add reference manually functionality in a project
    ...
    Examples:
      ...
      | Patentability   | Biotechnology   | TC_10_STA    | STA      | Manual Ref Title | Jesse PinkMan | General_Comment | 2020-03-18       | www.google.com | Citations | Source | Manual Abstract | DOI | Keywords | Full_text |
  ...
  Scenario Outline: TC_11_Validate Upload Patent functionality in a project
    ...
    Examples:
      ...
      | Patentability   | Biotechnology   | TC_11_STA    | STA      | Manual Ref Title | Manual Abstract | 1228337            | USSy1233  | Sample Inventor |



#TC_12, STA13, TC_14 _Validate STA can add, edit and delete annotation to a project
  Scenario Outline: TC_12, STA13, TC_14 _Validate STA can add, edit and delete annotation to a project
    Given Login with Credentials "<UserType>"
    And User filled all mandatory fields on page "both" with "<Type_Of_Project>", "<Technical_Field>", "<CaseMatterNo>"
    And Project is "successfully" created with name "<CaseMatterNo>"
    And Open created Project
    ...
    Examples:
      ...
      | Patentability   | Biotechnology   | TC_12_STA    | STA      | Feature1:123,Feature2:787,Feature3:7898 | US6000000  |                    | US6000000        | Line and column:Line data:Column data11 | Line and column:updated Line data:updatedColumn data11 |
...
#TC_16_Validate STA can import features
  Scenario Outline: TC_16_Validate STA can import features
    Given Login with Credentials "<UserType>"
    And User filled all mandatory fields on page "both" with "<Type_Of_Project>", "<Technical_Field>", "<CaseMatterNo>"
    And Project is "successfully" created with name "<CaseMatterNo>"
    And Open created Project
    ...
    Examples:
      ...
      | Patentability   | Biotechnology   | TC_16_STA    | STA      | Feature_1,Feature_2,Feature_3 | C:\GIT\ip-search\Features.csv |


    #TC_15, TC_17, TC_18, TC_19 Validate STA can add, update, reorder and delete features
  Scenario Outline: TC_15, TC_17, TC_18, TC_19 Validate STA can add, update, reorder and delete features
    Given Login with Credentials "<UserType>"
    And User filled all mandatory fields on page "both" with "<Type_Of_Project>", "<Technical_Field>", "<CaseMatterNo>"
    And Project is "successfully" created with name "<CaseMatterNo>"
    And Open created Project
    ...
    Examples:
      ...
      | Patentability   | Biotechnology   | TC_15_17_18_19_STA | STA      | Feature1:123,Feature2:787,Feature3:7898 | UpdatedFeature1:123,UpdateFeature2:787,UpdateFeature3:7898 | Feature2:787,Feature1:123,Feature3:7898 |



#STA_20_21 Validate STA can upload interim and Final report to a projects
  Scenario Outline: STA_20_21 Validate STA can upload interim and Final report to a projects
    Given Login with Credentials "<UserType>"
    And User filled all mandatory fields on page "both" with "<Type_Of_Project>", "<Technical_Field>", "<CaseMatterNo>"
    And Project is "successfully" created with name "<CaseMatterNo>"
    And Open created Project
    ...
    Examples:
      ...
      | Patentability   | Biotechnology   | TC_20_STA_Interim | STA      | new Interim Report | Interim report | Search in progress | Interim |
      | Patentability   | Biotechnology   | TC_20_STA_Final   | STA      | new Interim Report | Final report   | Report available   | Final   |

    #STA_25 and STA 26_Validate re-order and sorting results for STA
  Scenario Outline:STA_25 and STA 26_Validate re-order and sorting results for STA
    Given Login with Credentials "<UserType>"
    And User filled all mandatory fields on page "both" with "<Type_Of_Project>", "<Technical_Field>", "<CaseMatterNo>"
    And Project is "successfully" created with name "<CaseMatterNo>"
    And Open created Project
    ...
    Examples:
      ...
      | Patentability   | Biotechnology   | TC_25_STA    | STA      | Feature1:123,Feature2:787,Feature3:7898 | US3525361 US3525362 ABC | A cannot be found. | US3525362,US3525361  | US3525361,US3525362   |

  #STA_23, STA_24, and STA_27 STA can add keyword, share a reference in a project also add category to a references should not be available for STA in a project
  Scenario Outline: STA_23, STA_24, and STA_27 STA can add keyword, share a reference in a project also add category to a references should not be available for STA in a project
    Given Login with Credentials "<UserType>"
    And User filled all mandatory fields on page "both" with "<Type_Of_Project>", "<Technical_Field>", "<CaseMatterNo>"
    And Project is "successfully" created with name "<CaseMatterNo>"
    And Open created Project
    ...
    Examples:
      ...
      | Patentability   | Biotechnology   | TC_23_24_27_STA | STA      | Feature1:123,Feature2:787,Feature3:7898 | US6000000  |                    | US6000000        | keywordOne | wilmer.yates@nomail.example.com |


#STA_28_STA can add/update Introduction to a project
  Scenario Outline: STA_28_STA can add/update Introduction to a project
    Given Login with Credentials "<UserType>"
    And User filled all mandatory fields on page "both" with "<Type_Of_Project>", "<Technical_Field>", "<CaseMatterNo>"
    And Project is "successfully" created with name "<CaseMatterNo>"
    And Open created Project
    ...
    Examples:
      ...
      | Patentability   | Biotechnology   | TC_28_STA    | STA      | TC_28_STA_ New Introduction | TC_28_STA_ New Introduction_updated sucessfully |


#STA_29_31_32_Validate STA can add, Update and delete Search history line by line
  Scenario Outline: STA_29_31_32_Validate STA can add, update and delete Search history line by line
    Given Login with Credentials "<UserType>"
    And User filled all mandatory fields on page "both" with "<Type_Of_Project>", "<Technical_Field>", "<CaseMatterNo>"
    And Project is "successfully" created with name "<CaseMatterNo>"
    And Open created Project
...
#    Then "<Search_History_Delete_Entry>" is deleted successfully with message "No Search History has been added"
    ...
    Examples:
      ...
      | Patentability   | Biotechnology   | TC_28_STA    | STA      | Robotics and Automation Society | 1   | new Query for Robotics and Automation Society | 100    | Yes      | 10          | Updated new Query for Robotics and Automation Society | 8999           | no               |

#STA_33_Validate STA can re-order Search history
  Scenario Outline: STA_33_Validate STA can re-order Search history
    Given Login with Credentials "<UserType>"
    And User filled all mandatory fields on page "both" with "<Type_Of_Project>", "<Technical_Field>", "<CaseMatterNo>"
    And Project is "successfully" created with name "<CaseMatterNo>"
    And Open created Project
    ...
    Examples:
      ...
      | Patentability   | Biotechnology   | TC_33_STA    | STA      | Robotics and Automation Society | 1   | new Query for Robotics and Automation Society | 100    | Yes      | Engineering Village     | 100  | new Query for Engineering Village | 900     | Yes       |


  #STL_36, 37 and 38 STA can add, update and delete proposal to a project
  Scenario Outline: STL_36, 37 and 38 STA can add, update and delete proposal to a project
    Given Login with Credentials "<UserType>"
    And User filled all mandatory fields on page "both" with "<Type_Of_Project>", "<Technical_Field>", "<CaseMatterNo>"
    And Project is "successfully" created with name "<CaseMatterNo>"
    And Open created Project
    ...
    Examples:
      ...
      | Patentability   | Biotechnology   | TC_36_STA    | STA      | Proposal One  | proposalOne summary | EUR - Euro |
...
#    Then "ResultTab" is visible in the copied project
    ...
    Examples:
      ...
      | Patentability   | Biotechnology   | SEARCH_2686_Project | STA      | Proposal One  | proposalOne summary | SEARCH_2686_Introduction | EUR - Euro | Feature1:123,Feature2:787,Feature3:7898 | US3525361 US3525362 ABC | A cannot be found. | US3525361 US3525362 | Robotics and Automation Society | 1   | new Query for Robotics and Automation Society | 100    | Yes      | new Interim Report | Final report | Report available | Final  |
